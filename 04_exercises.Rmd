...
### Starbucks locations (`ggmap`)
  ...
  I can deduce that most Starbucks are located in North America, Europe, and Southeast Asia. Most Starbucks look like they're in the United States, specifically on the east and west coast.
...
```{r}
favorite_places_by_mary <- tibble(
...
```
  ...
  This map depicts the poverty concentration in conjunction with suspicious and traffic stops. It shows that generally, places with higher poverty concentrations have more suspicious vs. traffic stops.
...
[04_excercises.Rmd](https://github.com/mmcdonn1/weekly-exercises-4.git)
